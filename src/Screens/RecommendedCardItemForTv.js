            ...
            <CardItem>
                <View>   
                  ...
                  height:160,paddingHorizontal:20}}>
                     ...
                     <Text style={{fontSize:18,fontWeight:'bold',color:'blue'}}>Screen Size  <Text style={{fontSize:16,fontWeight:'bold',color:'black'}}>{this.props.ScreenSize}</Text></Text>
                     <Text style={{fontSize:18,fontWeight:'bold',color:'blue'}}>Resolution  <Text style={{fontSize:16,fontWeight:'bold',color:'black'}}>{this.props.Resolution}</Text></Text>
