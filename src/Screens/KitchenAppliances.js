...
import RecommendedCardItem from '../Screens/RecommendedCardItemForKitchenAppliances'
  ...
  componentDidMount() {
    ...
    RefData.once('value').then((snapshot) => {
      ...
      snapshot.forEach(childSnapshot => {
        ...
        var RefData2 = firebase.database().ref('Users/' + this.state.userIDfound + '/UserProducts/KitchenAppliances/');
            ...
            this.state.items.map(item => (
              <View>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => this.props.navigation.navigate('ViewProductsForKitchenAppliances',
                    {
                      key: item.ID,
                      Title: item.Title,
                      Brand: item.Brand,
